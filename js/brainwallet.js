(function($){
        ...
        var COINS = {
            ...
            nim_test: {
                name : "Nimiq",
                network: "Luna Testnet",
                prefix: 0x4f,
                private_prefix: 0x4f+0x80,
                bip32_public: NIMIQ_TESTNET_PUBLIC,
                bip32_private: NIMIQ_TESTNET_PRIVATE
            }
        };
    
        var coin = "nim_test";
        var PUBLIC_KEY_VERSION = 0x4f;
        var PRIVATE_KEY_VERSION = 0x80;
        var ADDRESS_URL_PREFIX = 'https://nimiq.watch/#'
        var BIP32_TYPE = NIMIQ_TESTNET_PRIVATE;
        var DEFAULT_SOURCE_KEY = "nqTpZW4H3z3whE1GiL1M5CAvKJ1Z9wFTtPHi59oPrqmMXUQdBSmQhsJyjqdXUtfk8j2vr5iUyR1CDbejChSbJQaRgfKTJQM9DZdwvUHqoDcsqV2";
        
        // var coin = "btc_main";
        // var PUBLIC_KEY_VERSION = 0;pu
        // var PRIVATE_KEY_VERSION = 0x80;
        // var ADDRESS_URL_PREFIX = 'http://blockchain.info/address/'
        // var BIP32_TYPE = BITCOIN_MAINNET_PRIVATE;
        // var DEFAULT_SOURCE_KEY = "xprv9s21ZrQH143K2JF8RafpqtKiTbsbaxEeUaMnNHsm5o6wCW3z8ySyH4UxFVSfZ8n7ESu7fgir8imbZKLYVBxFPND1pniTZ81vKfd45EHKX73";
        ...
        function updateSourceKey() {
            ...
            try {
                ...
                bip32_source_key.init().then(function(){
        ...
        function onAddressChange(){
            ...
            qrCode.addData(text.replace(/ /g,''));
            qrCode.make();
    
            $('#genAddrQR').html(qrCode.createImgTag(4));
            $('#genAddrURL').attr('href', ADDRESS_URL_PREFIX+text.replace(/ /g,'+'));
        ...
        $(document).ready( function() {
            ...
            Nimiq.init(async function() {
                ...
                $("#bip32_source_key").val(DEFAULT_SOURCE_KEY);
                ...
                $('#addr').on('change', onAddressChange);
